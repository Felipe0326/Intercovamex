...
include('../backend/backend_usuarios.php'); // Archivo backend con la lógica de citas
...
<script>
    ...
    // Si hay un parámetro 'added' que indica que la cita fue añadida correctamente
    if (urlParams.has('added') && urlParams.get('added') === 'true') {
        Swal.fire({
            icon: 'success',
            title: '¡Cita añadida!',
            text: 'La cita ha sido añadida correctamente.',
    ...
    // Si hay un parámetro 'edited' que indica que la cita fue editada correctamente
    ...
    // Si hay un parámetro 'deleted' que indica que la cita fue eliminada correctamente
    ...
    // Si hay un parámetro 'proposed' que indica que la cita fue propuesta correctamente
    if (urlParams.has('proposed') && urlParams.get('proposed') === 'true') {
        Swal.fire({
            icon: 'success',
            title: '¡Cita propuesta!',
            text: 'La cita ha sido propuesta correctamente.',
            showConfirmButton: false,
            timer: 3000,
            timerProgressBar: true,
        });
    ...
    // Si hay un parámetro 'emailSent' que indica que el correo fue enviado correctamente
    if (urlParams.has('emailSent') && urlParams.get('emailSent') === 'true') {
        Swal.fire({
            icon: 'success',
    ...
    // Si hay un parámetro 'historyViewed' que indica que el historial fue consultado correctamente
    if (urlParams.has('historyViewed') && urlParams.get('historyViewed') === 'true') {
        Swal.fire({
            icon: 'info',
            title: 'Historial de citas',
            text: 'El historial de citas ha sido consultado correctamente.',
            showConfirmButton: false,
            timer: 3000,
            timerProgressBar: true,
        });
    ...
    // Si hay un parámetro 'consulted' que indica que la cita fue consultada correctamente
    if (urlParams.has('consulted') && urlParams.get('consulted') === 'true') {
        Swal.fire({
            icon: 'info',
            title: 'Consulta realizada',
            text: 'La información de la cita ha sido consultada correctamente.',
            showConfirmButton: false,
            timer: 3000,
            timerProgressBar: true,
        });
