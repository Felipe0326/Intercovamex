...
include('../backend/backend_citas_clientesequipos.php'); // Conexión a la base de datos
        ...
        <?php foreach ($historial as $evento): ?>
            <div class="timeline-event">
                <div class="timeline-content">
                    ...
                    <p><strong>Estado de la Cita:</strong> <?php echo htmlspecialchars($evento['EstadoCita']); ?></p> <!-- Estado de la cita -->
                    <p><strong>Estatus de la Cita:</strong> <?php echo htmlspecialchars($evento['EstatusCita']); ?></p> <!-- Estatus de la cita -->
                    <p><strong>Folio:</strong> <?php echo htmlspecialchars($evento['CodigoFolio']); ?></p>
                    <form method="POST" action="../backend/generar_folio_pdf.php">
