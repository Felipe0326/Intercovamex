...
<body>
    ...
    <div class="buttons-left">
        ...
        <a href="../contacto/contacto_usuarios.php" class="btn"><i class="fas fa-user-plus"></i> Añadir Contacto</a>
    </div>
...
<script>
    ...
    // Si hay un parámetro 'added' que indica que la empresa fue añadida correctamente
    ...
    // Si hay un parámetro 'edited' que indica que la empresa fue editada correctamente
    ...
    // Si hay un parámetro 'deleted' que indica que la empresa fue eliminada correctamente
    ...
    // Si hay un parámetro 'consulted' que indica que la empresa fue consultada correctamente
    if (urlParams.has('consulted') && urlParams.get('consulted') === 'true') {
        Swal.fire({
            icon: 'info',
            title: 'Consulta realizada',
            text: 'La información de la empresa ha sido consultada correctamente.',
            showConfirmButton: false, // Oculta el botón "OK"
            timer: 3000, // Duración en milisegundos (3 segundos)
            timerProgressBar: true, // Muestra una barra de progreso
        });
